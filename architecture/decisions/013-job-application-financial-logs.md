...
Job Application tabs are Operations, Financial, Resume generation, and Logs. Gmail, financial defaults, profiles, and sources live on Settings (Job Application tab); see [030-consolidated-settings-tabs.md](030-consolidated-settings-tabs.md).
