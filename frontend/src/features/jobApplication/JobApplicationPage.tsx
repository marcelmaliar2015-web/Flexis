        ...
        <Stack spacing={3}>
          <Stack spacing={1}>
            ...
            <Typography variant="body2" color="text.secondary">
              Connect one Google account so Job Application can use Gmail, Sheets, and Drive on
              your behalf. Access is granted once, then Flexis can act without keeping your
              password.
            </Typography>
          </Stack>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  <Stack spacing={1}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      The same Google consent covers Sheets and Drive files this app creates or you
                      open with Flexis. Drive is limited to those files, not the rest of your Drive.
                    </Typography>
                  </Stack>
                  {status?.connected ? (
